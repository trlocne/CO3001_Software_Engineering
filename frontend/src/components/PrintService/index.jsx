    ...
    <div className={classes.all}>
      ...
      <div className={classes.wholeConfig}>
        <div className={classes.contentConfig}>
          ...
          {/* Left information */}
          <div className={classes.printInformation}>
            {/* First row */}
            <div className={classes.row}>
              <div className={classes.block}>
                <label for="location">Địa điểm</label>
                <input type="text" placeholder="Lý thường kiệt - H1 101" className={classes.input} id="location" />
              </div>
              <div className={classes.block}>
                <label for="printerParameter">Thông số máy in</label>
                <input type="text" placeholder="Thông số máy in" className={classes.input} id="printerParameter" />
              </div>
            </div>
            {/* Second row */}
            <div className={classes.row}>v      
              <input type="number" placeholder="Số bản in:" className={classes.inputSmall} />
            ...
            <div className={classes.row}>
              ...
              <input type="text" placeholder="Scale (%)" className={classes.inputSmall} />
            ...
            <fieldset className={classes.fieldset}>
              ...
              <div className={classes.radioGroup}>
                <label>
                  <input type="radio" name="page" /> All
                </label>
                <label>
                  <input type="radio" name="page" /> Old page only
                </label>
                <label>
                  <input type="radio" name="page" /> Even page only
                </label>
                <label>
                  <input type="radio" name="page" />
                  <input type="text" placeholder="Custom" className={classes.inputSmall} />
                </label>
              </div>
              <div className={classes.row}>
                <input type="text" placeholder="Page of sheet:" className={classes.inputSmall} />
                <input type="text" placeholder="Margin:" className={classes.inputSmall} />
              </div>
            </fieldset>
            {/* Share Section */}
            <fieldset className={classes.fieldset}>
              <legend>Share</legend>
              <div className={classes.row}>
                <input type="text" placeholder="Tiêu đề:" className={classes.input} />
                <input type="text" placeholder="Khoa:" className={classes.input} />
              </div>
              <div className={classes.row}>
                <input type="text" placeholder="Danh mục:" className={classes.input} />
                <input type="text" placeholder="Môn học:" className={classes.input} />
              </div>
              <div className={classes.row}>
                <input type="text" placeholder="Năm học:" className={classes.input} />
              </div>
            </fieldset>
          </div>

          {/* Right information */}
          <div className={classes.screenPage}>
