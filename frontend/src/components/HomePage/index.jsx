...
import img1 from '../../assets/bg_hcmut.png'
  ...
  return (
    <div className="lg:w-[100vw] mx-auto font-semibold relative bg-cover bg-[url(${img1})] bg-no-repeat	bg-fixed bg-center	 " style={{background: `url(${img1})`, backgroundSize: "cover"}}>
      ...
      <div className='flex flex-row justify-between h-[70px] items-center px-[5%] border border-b-gray-300'>
        ...
        <div>
          <ul className="flex flex-row min-w-[230px] justify-between font-semibold cursor-pointer">
            <li className='hover:text-[#4353FF] font-semibold'>Home</li>
            <li className='hover:text-[#4353FF] font-semibold'>Hướng dẫn sử dụng</li>
          </ul>
        </div>
        <div>
      ...
      <div className="flex flex-col w-[60vw] mt-[142px] ml-[15%]">
        ...
        <div className='flex flex-col bg-white rounded-[10px] shadow-md max-w-[500px] h-[164px] pb-[1em] px[0.5em] rounded-t-2xl'>
      ...
      <div className= 'bg-[#0D062D] w-100vm max-h-[230px] text-white text-sm py-[3em] px-[5em] mt-[120px]'>
        <div className='flex flex-row justify-between h-[180px]'>
          <div className='lg:flex flex-col w-[35%] hidden'>
            <img src={logo} className='w-[50px] h-[50px] py-[7px] bg-white rounded-full'/>  
            <div className='p-[5px]'>
