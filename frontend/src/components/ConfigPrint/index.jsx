...
const PrinterCard = ({ title, onDelete, processingPages, pageProgress, inkProgress }) => {
  // State to toggle overlay display
  ...
  return (
    <div className={classes.printerCard}>
      <div className={classes.printerCardHeader}>
        ...
        <h2 className={classes.printerCardTitle}>{title}</h2>
          ...
          <div className={classes.overlayContent} ref={overlayRef}>
            <form className={classes.printerForm}>
              ...
              <input
                ...
                type="number"
                id="pages"
                placeholder={processingPages}
              />

              <div className={classes.printerSubmit}>Save</div>
            </form>
          </div>
        </div>
      )}
...
export const ConfigPrint = () => {
  ...
  const [printers, setPrinters] = useState([
    { id: 1, title: 'H1-101', processingPages: 100, pageProgress: 70, inkProgress: 35 },
    { id: 2, title: 'H1-102', processingPages: 50, pageProgress: 50, inkProgress: 80 },
    { id: 3, title: 'H1-123', processingPages: 75, pageProgress: 60, inkProgress: 50 },
    { id: 4, title: 'H2-104', processingPages: 90, pageProgress: 3, inkProgress: 40 },
    { id: 5, title: 'H4-504', processingPages: 23, pageProgress: 80, inkProgress: 5 },
    { id: 6, title: 'H3-164', processingPages: 90, pageProgress: 80, inkProgress: 100 },
    { id: 7, title: 'H1-504', processingPages: 568, pageProgress: 80, inkProgress: 40 },
    { id: 8, title: 'H5-154', processingPages: 2367, pageProgress: 81, inkProgress: 40 },
    { id: 8, title: 'H5-154', processingPages: 90, pageProgress: 42, inkProgress: 40 },
  ]);
